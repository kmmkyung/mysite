                ...
                if (!vReg(cv, cid)) {
                    ...
                    */
                        ...
                        $.ajax({
                            ...
                            dataType:"html",
                            // 5.비동기옵션
                            // ajax 메서드는 비동기처리됨 다만 현재문서와의 동기처리를 하려면
                            // 비동기옵션값을 false로 해야함
                            // pass전역변수를 사용하기 위해 필요
                            // 최졷 트리거 blur 발생시 순서대로 처리할때 동기화해야하기 때문!
                            async:false,
                            // 6.성공처리
                            success:function(res){ // res 결과값리턴
                                ...
                                if(res==="ok"){
                                    ...
                                    // 불통과처리 -> pass 변수 사용이유로 async:false 옵션 사용함!
                                    pass = false;
                                }
                            }, ////success////
                            // 7.실패처리
                            // xhr - XMLHttpRequset 객체
                            // status - 실패상태코드
                            // error - 에러결과값
